    ...
    <main className="pt-32 pb-24 bg-background-dark min-h-screen text-white">
      ...
      <div className="max-w-3xl mx-auto px-6 lg:px-12">
        ...
        <p className="text-gray-300 leading-relaxed mb-6">
          Most drivers in Glasgow don't realise their car's paint is silently deteriorating every week. It doesn't happen overnight. It's a slow, relentless process driven by the exact conditions that define our climate — and by the time you notice the damage, it's expensive to fix.
        </p>
        <p className="text-gray-300 leading-relaxed mb-6">
        ...
        <p className="text-gray-300 leading-relaxed mb-6">
          Tree sap is highly acidic. If left on your paintwork — especially in warm weather — it bonds to the clear coat and is nearly impossible to remove without specialist products. Bird droppings are even worse. The uric acid in bird waste is potent enough to etch through an unprotected clear coat in as little as 48 hours.
        </p>
        <p className="text-gray-300 leading-relaxed mb-6">
        ...
        <p className="text-gray-300 leading-relaxed mb-6">
          For cars that haven't been corrected in a while, we often recommend a full paint correction before ceramic coating. This ensures the coating locks in a perfect, flawless finish — not just sealing in the existing swirls and scratches.
        </p>
