  ...
  return (
    <main className="pt-32 pb-24 bg-background-dark min-h-screen text-white">
      ...
      <div className="max-w-3xl mx-auto px-6 lg:px-12">
        ...
        <p className="text-gray-300 leading-relaxed mb-6">
          Car detailing goes further. It's a <strong className="text-white">restoration and protection process</strong> that addresses the actual condition of your paintwork, not just the surface dirt on top of it. A full detail doesn't just clean your car. It corrects it, refines it, and seals that condition in.
        </p>
        <p className="text-gray-300 leading-relaxed mb-6">
        ...
        <div className="space-y-6 mb-12">
          {[
            ...
            },
            {
              ...
              a: "Yes. Glasgow Car Valeting offers the full range: mini valet and full valet through to machine polishing, paint correction, and ceramic coating. All services are fully mobile. We come to your home or workplace across Glasgow and surrounding areas."
            },
          ].map((faq, i) => (
